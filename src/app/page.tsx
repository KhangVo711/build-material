...
export default function Home() {
  return (
    <div>
      <div
        className="relative h-[400px] sm:h-[450px] md:h-[500px] lg:h-[550px] overflow-hidden bg-[url('http://econaur.com/wp-content/uploads/2021/05/Building-Materials.jpg')] bg-cover bg-center bg-no-repeat">
        <div
          ...
          <div className="flex h-full items-center justify-center">
            <div className="flex items-center flex-col px-4 sm:px-6 md:px-12 text-center text-white">
              <h1 className="mb-6 text-3xl sm:text-4xl md:text-5xl font-bold">Construction Material</h1>
