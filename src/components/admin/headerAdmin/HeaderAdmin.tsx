      ...
      <div className="w-full h-16 px-3 bg-gray-100 border-b flex items-center justify-between">
        ...
        <div className="flex items-center relative">
          ...
          >
            ...
            <Image onClick={toggleDropdown} src="https://cdn.pixabay.com/photo/2024/10/15/02/12/cat-9121108_640.jpg" alt="ATV" width="500" height="500" className="w-12 h-12 rounded-full shadow-lg cursor-pointer ml-4" />
        </div>
