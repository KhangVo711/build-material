...
import { ChevronRightIcon } from '@heroicons/react/24/solid'; // Heroicon import
import {
  Chart,
  LineController,
  LineElement,
  ...
  return (
    <div id="home" className='p-8 overflow-x-hidden'>
      ...
      <div className="lg:flex justify-between items-center mb-6">
        <p className="text-2xl font-semibold mb-2 lg:mb-0">Good afternoon, Huyen Tran!</p>
